	...
	<div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'category' || searchType == 'sub_category' ? '' : 'none'}">
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'sub_category' ? '' : 'none'}">
		...
		methods: {
			...
			onChangeSearchType() {
				...
				if (this.searchType == 'quantity') {
					...
					this.getUsers();
				} else if (this.searchType == 'category' || this.searchType == 'sub_category') {
					this.getCategories();
			...
			onChangeCategory() {
				if (this.searchType == 'sub_category') {
