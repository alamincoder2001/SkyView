...
$route['sub_category'] = 'Administrator/Page/subCategory';
$route['save_sub_category'] = 'Administrator/Page/saveSubCategory';
$route['get_sub_categories'] = 'Administrator/Page/getSubCategories';
$route['delete_sub_category'] = 'Administrator/Page/deleteSubCategory';
...
$route['GenerateBarcode/(:any)/(:any)'] = 'BarcodeController/barcode_create/$1/$2';
